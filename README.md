...
The current version of `eqasim-java` is `2.4.0`. New versions are created with every Github release and can be used as a Maven dependency. First, you need to add our [packagecloud repository](https://packagecloud.io/eth-ivt/eqasim) to your `pom.xml`:
