...
public class RunAdaptConfig {
	static public void main(String[] args) throws ConfigurationException {
		...
		ConfigAdapter.run(args, new BraunschweigConfigurator(cmd), RunAdaptConfig::adaptConfiguration);
	}
	...
	static public void adaptConfiguration(Config config, String prefix) {
		...
		networkModes.add(BraunschweigModeChoiceModule.CAR_PASSENGER);
		...
		eqasimConfig.setCostModel(TransportMode.car, BraunschweigModeChoiceModule.CAR_COST_MODEL_NAME);
		eqasimConfig.setCostModel(TransportMode.pt, BraunschweigModeChoiceModule.PT_COST_MODEL_NAME);

		eqasimConfig.setEstimator(TransportMode.car, BraunschweigModeChoiceModule.CAR_ESTIMATOR_NAME);
		eqasimConfig.setEstimator(TransportMode.pt, BraunschweigModeChoiceModule.PT_ESTIMATOR_NAME);
		eqasimConfig.setEstimator(BraunschweigModeChoiceModule.BICYCLE, BraunschweigModeChoiceModule.BICYCLE_ESTIMATOR_NAME);
		eqasimConfig.setEstimator(BraunschweigModeChoiceModule.CAR_PASSENGER, BraunschweigModeChoiceModule.CAR_PASSENGER_ESTIMATOR_NAME);
		...
		dmcConfig.setModeAvailability(BraunschweigModeChoiceModule.MODE_AVAILABILITY_NAME);
		dmcConfig.setCachedModes(Arrays.asList("car", "bicycle", "pt", "walk", BraunschweigModeChoiceModule.CAR_PASSENGER, "truck"));
