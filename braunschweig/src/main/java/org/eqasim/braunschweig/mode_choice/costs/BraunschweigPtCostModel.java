package org.eqasim.braunschweig.mode_choice.costs;
...
public class BraunschweigPtCostModel implements CostModel {
	...
	@Inject
	public BraunschweigPtCostModel(TransitSchedule schedule, TimeInterpretation timeInterpretation,
			BraunschweigPersonPredictor personPredictor, PersonPredictor generalPersonPredictor) {
