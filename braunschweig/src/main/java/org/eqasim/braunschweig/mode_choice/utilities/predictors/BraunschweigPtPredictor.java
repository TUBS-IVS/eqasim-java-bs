...
public class BraunschweigPtPredictor extends CachedVariablePredictor<BraunschweigPtVariables> {
	static public final String MUNICH_ATTRIBUTE = "isMunich";

	private final TransitSchedule schedule;

	@Inject
	public BraunschweigPtPredictor(TransitSchedule schedule) {
	...
	@Override
	public BraunschweigPtVariables predict(Person person, DiscreteModeChoiceTrip trip, List<? extends PlanElement> elements) {
		...
		return new BraunschweigPtVariables(inVehicleTime_min, waitingTime_min, accessEgressTime_min, numberOfLineSwitches,
