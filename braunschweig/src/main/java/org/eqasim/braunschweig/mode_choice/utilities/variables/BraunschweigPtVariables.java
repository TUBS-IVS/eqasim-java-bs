...
public class BraunschweigPtVariables implements BaseVariables {
	...
	public BraunschweigPtVariables(double inVehicleTime_min, double waitingTime_min, double accessEgressTime_min,
